...
#import "AutomaticVideoProcessing3.h"

@interface AutomaticVideoProcessing3 ()

@end

@implementation AutomaticVideoProcessing3
...
//    UIImageView * header =[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"HipToLip.png"]];
    ...
    NSString *filename = @"HipToLipDrill.mov";
    videoFilename = filename;
    
    NSString * MovieLocation= [[NSBundle mainBundle]pathForResource:@"HipToLipDrill"ofType:@"mov"];//Details of the video location this is connected to the button
